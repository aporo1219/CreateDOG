...
//    {
//    case ATTACK:
//        return FText::FromString(TEXT("攻撃しろ!"));
//    case MOVEMENT:
//        return FText::FromString(TEXT("移動しろ!"));
//    case JUMP:
//        return FText::FromString(TEXT("ジャンプしろ!"));
//    case A_LITTLE_MORE:
//        return FText::FromString(TEXT("もう少しだ!"));
//    case DANGEROUS:
//        return FText::FromString(TEXT("危ない!"));
//    case STAGE_1:
//        return FText::FromString(TEXT("命運は任せたぞ"));
//    case STAGE_2:
//        return FText::FromString(TEXT("敵の動きに惑わされるな"));
//    case STAGE_3:
//        return FText::FromString(TEXT("足元注意"));
//    case STAGE_4:
//        return FText::FromString(TEXT("操作が反転してしまう"));
//    }
//
//    return FText();
//}